...
export function ContactSection() {
  ...
  const FORMSPREE_ENDPOINT = "https://formspree.io/f/xgopndpd";
          ...
          <motion.div className="lg:col-span-5 space-y-10" initial={{ opacity: 0, x: -50 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
            ...
            <div className="space-y-8">
              <div className="flex gap-6">
                ...
                <div>
                  ...
                  <a href="mailto:vihangasan221@gmail.com" className="text-white hover:text-blue-400 transition-colors text-lg block">
            ...
            <div className="rounded-3xl overflow-hidden border border-white/10 shadow-2xl">
              <iframe
                ...
                title="Vihanga Rathnayake - Buttala, Sri Lanka"
              />
            </div>
          </motion.div>
        ...
        >
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <p className="text-gray-500 text-sm">
              © {new Date().getFullYear()} Vihanga Rathnayake · Sri Lanka
            </p>
            <div className="flex items-center gap-4">
              <a href="https://github.com/VihangaR11" target="_blank" rel="noopener noreferrer"
                className="text-gray-500 hover:text-white transition-colors text-sm">GitHub</a>
              <span className="text-white/10">·</span>
              <a href="https://linkedin.com/in/vihanga-rathnayake-a6a652321" target="_blank" rel="noopener noreferrer"
                className="text-gray-500 hover:text-blue-400 transition-colors text-sm">LinkedIn</a>
              <span className="text-white/10">·</span>
              <a href="mailto:vihangasan221@gmail.com"
                className="text-gray-500 hover:text-blue-400 transition-colors text-sm">Email</a>
            </div>
          </div>
        </motion.footer>
      </div>
