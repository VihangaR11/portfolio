        ...
        >
          {testimonials.map((testimonial, index) => (
            <motion.div
              ...
              className="group bg-white/5 backdrop-blur-lg border border-white/10 rounded-2xl p-6 md:p-8 transition-all duration-300 hover:bg-white/10 hover:shadow-lg hover:shadow-blue-500/10 hover:border-white/20 relative"
            >
              {/* Quote Icon */}
              ...
              <div className="flex items-center gap-4">
                <div className="flex-shrink-0 w-12 h-12 rounded-full bg-gradient-to-r from-blue-400 to-blue-700 flex items-center justify-center">
