...
const strengths = [
  {
    ...
    color: '#4da6ff',
    bg: 'rgba(30,107,196,0.1)',
    border: 'rgba(30,107,196,0.25)',
  },
  {
    icon: ZapIcon,
    title: 'DevOps & Cloud',
    ...
    color: '#c8a03c',
    bg: 'rgba(200,160,60,0.1)',
    border: 'rgba(200,160,60,0.25)',
  },
  {
    icon: UsersIcon,
...
// ─── Key facts ────────────────────────────────────────────────────────────
const facts = [
  { icon: GraduationCapIcon, label: 'Dual degrees', value: 'USJ + OUSL', color: '#c8a03c' },
  { icon: BriefcaseIcon,     label: 'Status',       value: 'Open to work', color: '#10b981' },
  { icon: MapPinIcon,        label: 'Location',     value: 'Sri Lanka',    color: '#4da6ff' },
  { icon: CodeIcon,          label: 'Experience',   value: '3+ years',     color: '#f59e0b' },
];
        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-start mb-14">
          ...
          >
            ...
            <h3 className="text-xl sm:text-2xl font-bold text-white leading-snug">
              I'm <span className="text-blue-400">Vihanga Rathnayake</span> —
          ...
          >
            ...
            <div
              ...
              style={{
                background: 'rgba(30,107,196,0.04)',
                borderColor: 'rgba(30,107,196,0.15)',
              }}
            >
