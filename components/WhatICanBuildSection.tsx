  ...
  return (
    <section className="py-20 px-6" id="what-i-can-build">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-blue-400 to-blue-700 bg-clip-text text-transparent mb-6">
            What I Can Build
          </h2>
                      ...
                      <div key={category}>
                        ...
                        <div className="flex flex-wrap gap-2">
                          {technologies.map((tech) => (
                            <span
                              key={tech}
                              className="px-3 py-1 bg-amber-500/20 text-amber-300 rounded-full text-sm font-medium border border-amber-500/30"
                            >
                              {tech}
                            </span>
                          ))}
                ...
                <div>
                  ...
                  {!showCodePreview && (
                    <div className="bg-gray-900 rounded-lg p-8 text-center">
                      <PlayIcon className="w-12 h-12 text-blue-400 mx-auto mb-4" />
