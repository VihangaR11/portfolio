        ...
        >
          {articles.map((article) => (
            <motion.article
              ...
              className="group bg-white/5 backdrop-blur-lg border border-white/10 rounded-2xl overflow-hidden transition-all duration-300 hover:scale-[1.02] hover:shadow-xl hover:shadow-blue-500/10 hover:border-white/20"
            >
              ...
              <div className="p-6">
                ...
                {/* Read More Link */}
                <button className="flex items-center gap-2 text-blue-400 text-sm font-semibold group-hover:gap-3 transition-all">
                  Read More
