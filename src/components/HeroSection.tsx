  ...
  const initCanvas = useCallback(() => {
    ...
    class Particle {
      ...
      draw(ctx) {
        ...
        grad.addColorStop(0,   `rgba(6,182,212,${this.opacity})`);
        grad.addColorStop(0.4, `rgba(139,92,246,${this.opacity * 0.6})`);
        ...
        ctx.fillStyle = `rgba(200,240,255,${this.opacity + 0.3})`;
        ctx.fill();
      }
    }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-16 xl:gap-20">
          ...
          >
            ...
            <motion.p className="text-cyan-400 font-mono text-sm tracking-[0.2em] mb-3"
            ...
            >
              <span className="bg-gradient-to-r from-cyan-400 via-cyan-300 to-violet-500 bg-clip-text text-transparent">Vihanga</span>
              <br />
              <span className="bg-gradient-to-r from-violet-500 via-violet-400 to-cyan-400 bg-clip-text text-transparent">Rathnayake</span>
            </motion.h1>
            ...
            <motion.div className="h-9 mb-5 overflow-hidden"
              ...
              <AnimatePresence mode="wait">
                <motion.div key={currentRoleIndex}
                  ...
                  <span className="w-8 h-px flex-shrink-0" style={{ background: 'linear-gradient(to right, #06b6d4, transparent)' }} />
          ...
          <motion.div className="flex-shrink-0 order-1 lg:order-2" style={{ y: imageY }}
            ...
            <div className="relative">
              ...
              <motion.div className="absolute -inset-3 rounded-full border-2 border-dashed opacity-20"
                style={{ borderColor: '#06b6d4' }} animate={{ rotate: 360 }}
              ...
              <div className="relative p-1.5 rounded-full animate-glow-border"
                ...
                <div className="rounded-full overflow-hidden bg-gradient-to-br from-cyan-500/20 to-violet-500/20 flex items-center justify-center"
                  ...
                  {!imageError ? (
                    ...
                    <div className="text-center">
                      <span className="text-8xl font-extrabold bg-gradient-to-r from-cyan-400 to-violet-500 bg-clip-text text-transparent block">VR</span>
              ...
              <motion.div className="absolute -top-2 -left-2 flex items-center gap-2 px-3 py-2 rounded-xl border text-xs font-medium"
                style={{ background: 'rgba(8,12,16,0.95)', borderColor: 'rgba(6,182,212,0.3)', color: '#06b6d4', backdropFilter: 'blur(12px)' }}
              ...
              <div className="absolute -bottom-4 -left-4 w-8 h-8 bg-violet-500 rounded-full blur-md opacity-40 animate-pulse" style={{ animationDelay: '1s' }} />
            </div>
          </motion.div>
        </div>
