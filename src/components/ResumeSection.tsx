...
const TAB_CONFIG: {
  ...
  { id: 'experience',     label: 'Experience',     icon: BriefcaseIcon,    color: '#06b6d4', bg: 'rgba(6,182,212,0.1)',   border: 'rgba(6,182,212,0.3)' },
  { id: 'education',      label: 'Education',      icon: GraduationCapIcon,color: '#8b5cf6', bg: 'rgba(139,92,246,0.1)', border: 'rgba(139,92,246,0.3)' },
    ...
    <motion.div ref={ref} className="relative flex gap-4 mb-5"
      ...
      <div className="flex flex-col items-center flex-shrink-0">
        <div className="w-9 h-9 rounded-full flex items-center justify-center border-2 flex-shrink-0"
          style={{ background: '#0d1117', borderColor: color, boxShadow: `0 0 12px ${bg}` }}>
...
export function ResumeSection() {
  ...
  const stats = [
    { label: 'Degrees',    value: '2',  color: '#8b5cf6' },
    { label: 'Roles held', value: '15+', color: '#06b6d4' },
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-violet-500/4 rounded-full blur-3xl" />
      </div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <motion.div className="text-center mb-10"
          ...
          <p className="text-cyan-400 font-mono text-xs tracking-[0.3em] uppercase mb-3">— Skills & journey</p>
        ...
        <motion.div className="text-center mt-12"
          ...
          <a href="/Vihanga_Rathnayake_CV.pdf" download
            className="inline-flex items-center gap-2 px-6 py-3 rounded-xl font-semibold text-sm text-white transition-all duration-300 hover:brightness-110 hover:shadow-lg hover:shadow-cyan-500/25"
