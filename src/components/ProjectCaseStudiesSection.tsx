...
import { ExternalLinkIcon, GithubIcon, XIcon, TrendingUpIcon, UsersIcon, ZapIcon } from 'lucide-react';
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          {detailedProjects.map((project, index) => (
            <motion.div
              key={project.title}
              className="group bg-white/5 backdrop-blur-lg border border-white/10 rounded-2xl overflow-hidden cursor-pointer transition-all duration-300 hover:scale-[1.02] hover:shadow-xl hover:shadow-cyan-500/10 hover:border-white/20"
            ...
            >
              ...
              <div className="p-6">
                ...
                <button className="w-full py-2 text-cyan-400 text-sm font-semibold group-hover:text-cyan-300 transition-colors">
      ...
      <AnimatePresence>
        {selectedProject && (
          ...
          >
            <motion.div
              className="bg-[#0d1117] border border-white/10 rounded-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto"
            ...
            >
              ...
              <div className="p-6 md:p-8 space-y-6">
                ...
                {/* Solution */}
                <div>
                  <h3 className="text-xl font-bold text-violet-400 mb-3">💡 Solution</h3>
                ...
                {/* Results */}
                <div>
                  <h3 className="text-xl font-bold text-cyan-400 mb-3">🎉 Results</h3>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    {selectedProject.metrics.users && (
                      <div className="bg-white/5 border border-white/10 rounded-xl p-4 text-center">
                        <UsersIcon className="w-8 h-8 text-cyan-400 mx-auto mb-2" />
                    ...
                    {selectedProject.metrics.performance && (
                      <div className="bg-white/5 border border-white/10 rounded-xl p-4 text-center">
                        <ZapIcon className="w-8 h-8 text-violet-400 mx-auto mb-2" />
                        <div className="text-2xl font-bold text-white mb-1">
                          {selectedProject.metrics.performance}
                        </div>
