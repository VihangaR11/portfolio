...
export function BackgroundOrbs() {
  ...
  const COLORS = ['#06b6d4', '#8b5cf6', '#22d3ee', '#a78bfa'];
  ...
  return (
    <div
      ...
      <div className="absolute -top-32 -left-32 w-96 h-96 rounded-full bg-gradient-to-br from-cyan-400 to-cyan-600 opacity-20 blur-3xl animate-float-1" />
      <div className="absolute -top-20 right-0 w-80 h-80 rounded-full bg-gradient-to-br from-violet-500 to-purple-600 opacity-20 blur-3xl animate-float-2" />
      <div className="absolute bottom-0 right-1/4 w-[500px] h-[500px] rounded-full bg-gradient-to-tl from-violet-600 to-cyan-500 opacity-15 blur-3xl animate-float-4" />
      <div className="absolute top-1/2 -left-20 w-72 h-72 rounded-full bg-gradient-to-tr from-cyan-500 via-violet-500 to-purple-500 opacity-10 blur-3xl animate-float-3" />
