...
export function ThemeToggle() {
  ...
  return (
    <motion.button
      onClick={toggleTheme}
      className="fixed top-24 right-8 z-50 p-3 bg-white/5 backdrop-blur-lg border border-white/10 rounded-full hover:bg-white/10 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cyan-400 transition-all duration-300 group"
