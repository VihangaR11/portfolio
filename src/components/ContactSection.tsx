            ...
            <div className="bg-white/5 backdrop-blur-3xl border border-white/10 rounded-3xl p-10 md:p-12">
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <button
                  ...
                  className="w-full py-5 bg-gradient-to-r from-cyan-500 to-violet-600 rounded-2xl font-semibold text-lg text-white flex items-center justify-center gap-3 hover:brightness-110 transition-all disabled:opacity-70 disabled:cursor-not-allowed"
                >
                  {isSubmitting ? (
                    <>
