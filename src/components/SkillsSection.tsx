...
const skills = [
  { name: 'React', icon: Code2, color: 'blue', level: 92 },
  { name: 'TypeScript', icon: FileCode, color: 'amber', level: 88 },
  { name: 'Node.js', icon: Server, color: 'blue', level: 82 },
  { name: 'Python', icon: Brain, color: 'amber', level: 78 },
  { name: 'Figma', icon: Palette, color: 'blue', level: 85 },
  { name: 'AWS', icon: Cloud, color: 'amber', level: 76 },
  { name: 'Docker', icon: Container, color: 'blue', level: 83 },
  { name: 'Git', icon: GitBranch, color: 'amber', level: 90 },
  { name: 'GraphQL', icon: Share2, color: 'blue', level: 72 },
  { name: 'TailwindCSS', icon: Paintbrush, color: 'amber', level: 94 },
  { name: 'PostgreSQL', icon: Database, color: 'blue', level: 77 },
  { name: 'MongoDB', icon: Leaf, color: 'amber', level: 80 },
];
    ...
    <section id="skills" className="py-16 md:py-24 lg:py-32 relative">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <div className="w-28 h-1 bg-gradient-to-r from-blue-400 to-blue-700 mx-auto rounded-full mb-6" />
            ...
            >
              {skills.map((skill, i) => {
                ...
                return (
                  ...
                  >
                    <div className={`absolute inset-0 bg-gradient-to-br ${isCyan ? 'from-blue-500/10' : 'from-amber-500/10'} opacity-0 group-hover:opacity-100 transition-opacity rounded-3xl`} />

                    <div className="relative flex flex-col items-center text-center">
                      <div className={`w-24 h-24 rounded-3xl flex items-center justify-center mb-6 transition-all group-hover:scale-110 ${isCyan ? 'bg-blue-500/10 text-blue-400' : 'bg-amber-500/10 text-amber-400'}`}>
                      ...
                      <div className="w-full mt-auto">
                        ...
                        <div className="h-2 bg-white/10 rounded-full overflow-hidden">
                          <motion.div 
                            className={`h-full rounded-full ${isCyan ? 'bg-blue-400' : 'bg-amber-400'}`}
                            initial={{ width: 0 }}
